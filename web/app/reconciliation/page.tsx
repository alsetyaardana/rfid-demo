  ...
  return (
    <div className="screen">
      ...
      <section className="grid-4">
        <Metric label="Batch ID" value={batch?.batchCode ?? demoBatchCode} note="Active demo batch" tone="teal" />
      ...
      <section className="grid-3">
        ...
        <article className="card">
          ...
          <p>
            {item
              ? `${item.linenCode} was sent with ${demoBatchCode} but was not included in a valid return transaction. Inspect Laundry Dispatch Gate and re-scan before closing the batch.`
              : "No outstanding linen is currently detected for the active demo batch."}
          </p>
        </article>
      </section>
